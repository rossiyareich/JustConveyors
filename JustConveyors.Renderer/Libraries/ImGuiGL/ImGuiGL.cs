...
namespace JustConveyors.Renderer.Libraries.ImGuiGL;

public static class ImGuiGL
{
    public static (IntPtr, IntPtr) CreateWindowAndGLContext(string title, int width, int height,
        bool fullscreen = false, bool highDpi = false)
    {
    ...
    public static uint LoadTexture(IntPtr pixelData, int width, int height,
        ...
        PixelInternalFormat internalFormat = PixelInternalFormat.Rgba)
    {
        ...
        glTexImage2D(TextureTarget.Texture2D, 0, internalFormat, width, height, 0, format,
            PixelType.UnsignedByte, pixelData);
        glTexParameteri(TextureTarget.Texture2D, TextureParameterName.TextureMagFilter,
            TextureParameter.Linear);
        glTexParameteri(TextureTarget.Texture2D, TextureParameterName.TextureMinFilter,
            TextureParameter.Linear);
