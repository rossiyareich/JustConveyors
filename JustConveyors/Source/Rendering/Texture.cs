...
internal class Texture : IRenderComponent
{
    ...
    public static IntPtr Copy(IntPtr inSurface)
    {
        SDL_Surface inSurfaceMarshalled = PtrToSurface(inSurface);
        IntPtr outSurface = SDL_CreateRGBSurface(0, inSurfaceMarshalled.w, inSurfaceMarshalled.h, 32, 0x000000ff,
            0x0000ff00, 0x00ff0000, 0xff000000);
        SDL_BlitSurface(inSurface, IntPtr.Zero, outSurface, IntPtr.Zero);
        return outSurface;
    }
}
